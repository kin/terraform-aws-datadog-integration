...
| <a name="module_kinesis"></a> [kinesis](#module\_kinesis) | ./kinesis | n/a |
...
| <a name="input_enable_kinesis"></a> [enable\_kinesis](#input\_enable\_kinesis) | Enable Kinesis integration | `bool` | `false` | no |
...
| <a name="input_kinesis_api_key_ssm_parameter_name"></a> [kinesis\_api\_key\_ssm\_parameter\_name](#input\_kinesis\_api\_key\_ssm\_parameter\_name) | SSM param for Datadog api key to use for kinesis auth | `string` | `""` | no |
| <a name="input_kinesis_bucket_arn"></a> [kinesis\_bucket\_arn](#input\_kinesis\_bucket\_arn) | ARN for kinesis retry bucket | `string` | `""` | no |
| <a name="input_kinesis_endpoint"></a> [kinesis\_endpoint](#input\_kinesis\_endpoint) | Endpoint for kinesis | `string` | `"https://awsmetrics-intake.datadoghq.com/v1/input"` | no |
